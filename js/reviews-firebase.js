...
const buildReview = (text, name, city) => `
  <div class="review-card">
    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-yellow-400/20">
      <i class="fa-solid fa-quote-left text-xs text-yellow-400"></i>
    </span>
    <span class="font-bold tracking-tight">"${text}"</span>
    <span class="font-bold text-yellow-400">– ${name}, ${city}</span>
  </div>
`;
